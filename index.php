...
if(isset($_SESSION['session'])) {  //si esta logueado entonces llamar a principal
	header("location:chat/principal.php"); 
	exit;
}
...
<body>
	...
	<div id="envoltura">
		<div id="contenedor">
			...
			<div id="cuerpo">
				<form id="form-login" action="./gestion_usuarios/login.php" method="post" autocomplete="off">
